	...
	public TreeGUI() {
		...
		clearButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				tm.clear();   // added by me
				tree = null; // Added by me
...
//					first_undo = true; //added by me
		...
		deleteButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				boolean a = tree.isRootNode(n);
				if (a) {
//					JOptionPane.showMessageDialog(null, "Is the root node");
//					return;
					
				}
				else {
					JOptionPane.showMessageDialog(null, "Not the root node");
...
//					 first_undo = true; //added by me
		...
		undoButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (tree == null) {
					JOptionPane.showMessageDialog(null, "Tree is empty. No action to UnDo.");
					return;
				}
				else {
					tree = tm.get_state();
...
// insert() calls protected abstract add_node()
	...
	public boolean isRootNode(int n) {
		AbsTree t = find(n);
		if (t == this) {
			return true;
		}
